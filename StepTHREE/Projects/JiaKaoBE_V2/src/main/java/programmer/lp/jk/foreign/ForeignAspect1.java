package programmer.lp.jk.foreign;
...
import programmer.lp.jk.foreign.anno.ForeignCascade;
import programmer.lp.jk.foreign.anno.ForeignField;
import programmer.lp.jk.foreign.info.ForeignFieldInfo;
import programmer.lp.jk.foreign.info.ForeignTableInfo;
import programmer.lp.jk.util.Classes;
import programmer.lp.jk.util.JsonVos;
import programmer.lp.jk.util.Strings;
...
@Aspect
@Component
public class ForeignAspect1 implements InitializingBean, ApplicationContextAware {
    private static final String FOREIGN_SCAN = "classpath*:programmer/lp/jk/pojo/po/**/*.class";

    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* programmer.lp.jk.service..*.remove*(..))")
    ...
    @Around("execution(* programmer.lp.jk.service..*.save*(..)) || execution(* programmer.lp.jk.service..*.update*(..)) ")
