                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-validation"
                            ...
                            <input style="display: none" name="photo" value="${user.photo}">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="name"
                                                   value="${user.name}" name="name" maxlength="20" class="form-control"
                                                   placeholder="姓名">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="job"
                                                   value="${user.job}" name="job" maxlength="20" class="form-control"
                                                   placeholder="工作">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="phone"
                                                   value="${user.phone}" name="phone" maxlength="20"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input id="trait"
                                                   value="${user.trait}" name="trait" maxlength="100" type="text"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input id="interests"
                                                   value="${user.interests}" name="interests" maxlength="100"
                                                   type="text"
                                                   class="form-control" data-role="tagsinput"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="date"
                                                   value="<f:formatDate value="${user.birthday}" pattern="yyyy-MM-dd"/>"
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"
                                                   ...
                                                   class="form-control" placeholder="住址">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea name="intro" maxlength="1000" id="intro" cols="30" rows="5"
                                                      class="form-control no-resize" placeholder="简介">${user.intro}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
