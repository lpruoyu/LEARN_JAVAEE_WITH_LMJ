...
<head>
    ...
    <link href="${ctx}/static/asset/plugin/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet">
    ...
    <link href="${ctx}/static/asset/admin/css/theme-blue.min.css" rel="stylesheet">
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">LP简历管理</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            <div class="image">
                <img src="${ctx}/static/asset/admin/img/avatar.png" alt="User">
            </div>
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li><a href="${ctx}/static/front/user.html"><i class="material-icons">person</i>个人信息</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${ctx}/static/login.jsp"><i class="material-icons">input</i>退出登录</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="menu">
            <ul class="list">
                <li>
                    <a href="${ctx}/static/admin/user.html">
                        <i class="material-icons">person</i>
                        <span>个人信息</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/skill.html">
                        <i class="material-icons">accessibility</i>
                        <span>专业技能</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/password.html">
                        <i class="material-icons">lock</i>
                        <span>修改密码</span>
                    </a>
                </li>
                <li class="active">
                    <a href="${ctx}/static/admin/education.jsp">
                        <i class="material-icons">school</i>
                        <span>教育经验</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/company.html">
                        <i class="material-icons">domain</i>
                        <span>公司信息</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/experience.html">
                        <i class="material-icons">work</i>
                        <span>工作经验</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/project.html">
                        <i class="material-icons">build</i>
                        <span>项目经验</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/award.html">
                        <i class="material-icons">plus_one</i>
                        <span>获奖成就</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/contact.html">
                        <i class="material-icons">comment</i>
                        <span>留言信息</span>
                    </a>
                </li>
                <li>
                    <a href="${ctx}/static/admin/website.jsp">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <c:forEach var="education" items="${educations}">
                                    <tr>
                                        <td>
                                            <div class="switch">
                                                <label><input name="id" value="${education.id}" type="checkbox"><span
                                                        class="lever switch-col-blue"></span></label>
                                            </div>
                                        </td>
...
<script src="${ctx}/static/asset/plugin/bootstrap-fileinput/bootstrap-fileinput.js"></script>
<script src="${ctx}/static/asset/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>
...
<script src="${ctx}/static/asset/plugin/sweetalert/sweetalert.min.js"></script>
