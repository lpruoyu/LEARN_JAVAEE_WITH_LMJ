    ...
    <header id="crt-header">
        <nav id="crt-nav-sm" class="crt-nav hidden-lg hidden-md">
            <ul class="clear-list">
                <li>
                    <a href="user.html">
                        <img class="avatar avatar-42" src="${ctx}/asset/front/img/avatar/avatar-42x42.png" alt="">
                    </a>
                </li>
                            ...
                            <ul class="clear-list">
                                <li>
                                    <a href="user.html" data-tooltip="首页">
                                        <img class="avatar avatar-42" src="${ctx}/asset/front/img/avatar/avatar-42x42.png"
                                             alt="">
                                    </a>
                                </li>
                                ...
                                <li><a href="contact.html" data-tooltip="联系我吧"><span
                                        class="crt-icon crt-icon-contact"></span></a></li>
                                <li><a href="${ctx}/WEB-INF/admin/user.html" data-tooltip="后台管理"><span
                                        class="crt-icon crt-icon-key"></span></a></li>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="crt-paper clear-mrg">
                    ...
                    <section class="section padd-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 clear-mrg">
                                <div class="award-box">
                                    <img class="award-img" src="${ctx}/asset/front/img/awards/award01.jpeg" alt="">
